...
# new in 0.3: 随机 referer
# fixed in 0.3: str issue by switched to python 3
# new in 0.31: seperater purifier
# new in 0.4: update note
# new in 0.4: origin sniffer
# <del>tbf: fuck csv especially the fucking headers issue</del>
# fixed in 0.4: fucing csv issues
# tbd: email me after work
